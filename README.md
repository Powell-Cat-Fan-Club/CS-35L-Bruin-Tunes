...
5. Type `node server.js` to start runnning the server and database. If done successfully, you should see the following:

      > Server is running on port: 5000
      > 
      > Successfully connected to MongoDB.
6. Finally, type `npm start` to run the project in your browser. 
